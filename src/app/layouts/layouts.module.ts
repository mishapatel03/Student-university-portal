...
//     { path:'layout/home', component: HomeComponent },
//     { path:'layout/feedback', component: FeedbackComponent },
//     { path:'layout/degreecertificate', component: DegreecertificateComponent },
//     { path:'layout/transcript', component: TranscriptComponent },
//     { path:'layout/results', component: ResultsComponent },
//     { path:'layout/payment', component: PaymentComponent },
//     {
